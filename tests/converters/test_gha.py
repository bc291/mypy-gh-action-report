...
def test_output_workflow_command(capsys, data):
    ...
    assert stdout_msg == [
        "::error title=Error code%3A `arg-type`,file=app/core/core.py,line=18,endLine=,col=,endColumn=::"
        "Argument 1 to 'test' has incompatible type 'str'; expected 'int'",
        "::error title=Error code%3A `assignment`,file=app/models/model.py,line=53,endLine=,col=,endColumn=::"
        "Incompatible types in assignment (expression has type 'str', variable has type 'int')",
        "::error title=Error code%3A `assignment`,file=app/models/model.py,line=54,endLine=,col=,endColumn=::"
        "Incompatible types in assignment (expression has type 'str', variable has type 'int')",
        "::error title=Error code%3A `assignment`,file=app/services/service.py,line=57,endLine=,col=,endColumn=::"
        "Incompatible default for argument 'get_data' (default has type 'int', argument has type 'str')",
        "::warning title=,file=app/services/service2/file1.py,line=66,endLine=,col=,endColumn=::"
